import sys
sys.path.append('/home/zengguangjie/data/HypSEE')
sys.path.append('/home/zengguangjie/HypSEE')
...
class Exp:
    ...
    def exp(self):
        ...
        file_name = f"{self.configs['result_root']}/{self.configs.data_name}/Time_{current_time}_ACC_{self.configs.mean}.txt"
